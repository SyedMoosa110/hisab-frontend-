  ...
  return <div className="app">
    ...
    <aside className={menuOpen ? 'sidebar open' : 'sidebar'}>
      ...
      <div style={{
        ...
        <p style={{ margin: '0 0 4px 0', fontSize: '9px', textTransform: 'uppercase', letterSpacing: '0.5px' }}>Generated by App</p>
        <p style={{ margin: '0 0 2px 0' }}>Developed & updated by:</p>
        <p style={{ margin: '0 0 2px 0', fontWeight: 'bold', fontSize: '12px', color: '#ffffff' }}>CGPLUX STUDIOS</p>
        <a href="https://cgpluxstudios.com/" target="_blank" rel="noopener noreferrer" style={{ color: '#38bdf8', textDecoration: 'none', display: 'block', marginBottom: '4px' }}>cgpluxstudios.com</a>
        <p style={{ margin: '0 0 2px 0' }}>Call: +92 319 1086099</p>
        <p style={{ margin: 0 }}>Email: info@cgpluxstudios.com</p>
      </div>
    </aside>
    <main>
